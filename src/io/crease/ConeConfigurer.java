...
import core.crease.Cone;
import io.CreaseConfigurer;
import parameter.parameter.DoubleParameter;

/**
 * A configurer that handles cone crease functions.
 *
 * @author Javier Centeno Vega <jacenve@telefonica.net>
 * @version 0.3
 * @since 0.3
 * @see io.CreaseConfigurer
 * @see core.crease.Cone
 *
 */
public class ConeConfigurer extends CreaseConfigurer<Cone> {
	...
	/**
	 * Construct a new cone crease configurer with default parameters.
	 * 
	 * @param nameKey The internationalization key for the name of the configurer.
	 */
	public ConeConfigurer(String nameKey) {
		super(nameKey);
	...
	@Override
	public Cone generate() {
		return new Cone(heightFactor.getCurrentValue().getValue(), heightPower.getCurrentValue().getValue(),
