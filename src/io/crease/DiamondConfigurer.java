...
import core.crease.Diamond;
import io.CreaseConfigurer;
import parameter.parameter.DoubleParameter;

/**
 * A configurer that handles diamond crease functions.
 *
 * @author Javier Centeno Vega <jacenve@telefonica.net>
 * @version 0.3
 * @since 0.3
 * @see io.CreaseConfigurer
 * @see core.crease.Diamond
 *
 */
public class DiamondConfigurer extends CreaseConfigurer<Diamond> {
	...
	/**
	 * Construct a new diamond crease configurer with default parameters.
	 * 
	 * @param nameKey The internationalization key for the name of the configurer.
	 */
	public DiamondConfigurer(String nameKey) {
		super(nameKey);
	...
	@Override
	public Diamond generate() {
		return new Diamond(heightFactor.getCurrentValue().getValue(), heightPower.getCurrentValue().getValue(),
