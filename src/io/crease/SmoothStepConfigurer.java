...
/**
 * A configurer that handles smoothstep crease functions.
 *
 * @author Javier Centeno Vega <jacenve@telefonica.net>
 * @version 0.3
 * @since 0.3
 * @see io.CreaseConfigurer
 * @see core.crease.SmoothStep
 *
 */
public class SmoothStepConfigurer extends CreaseConfigurer<SmoothStep> {
	...
	/**
	 * Construct a new smooth step crease configurer with default parameters.
	 * 
	 * @param nameKey The internationalization key for the name of the configurer.
	 */
	public SmoothStepConfigurer(String nameKey) {
		super(nameKey);
	...
	@Override
	public SmoothStep generate() {
		return new SmoothStep(heightFactor.getCurrentValue().getValue(), heightPower.getCurrentValue().getValue(),
