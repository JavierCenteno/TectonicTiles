...
import core.crease.Pyramid;
import io.CreaseConfigurer;
import parameter.parameter.DoubleParameter;

/**
 * A configurer that handles pyramid crease functions.
 *
 * @author Javier Centeno Vega <jacenve@telefonica.net>
 * @version 0.3
 * @since 0.3
 * @see io.CreaseConfigurer
 * @see core.crease.Pyramid
 *
 */
public class PyramidConfigurer extends CreaseConfigurer<Pyramid> {
	...
	/**
	 * Construct a new pyramid crease configurer with default parameters.
	 * 
	 * @param nameKey The internationalization key for the name of the configurer.
	 */
	public PyramidConfigurer(String nameKey) {
		super(nameKey);
	...
	@Override
	public Pyramid generate() {
		return new Pyramid(heightFactor.getCurrentValue().getValue(), heightPower.getCurrentValue().getValue(),
