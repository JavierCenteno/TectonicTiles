...
/**
 * Definition of the cone crease function. This function uses the Euclidean
 * distance to the center to determine its value.
 *
...
public class Cone implements Crease {
	...
	/**
	 * Construct a new cone crease function.
	 * 
