...
public class MultiparameterPanel extends JPanel implements ActionListener {
	...
	private static final InternationalizedString IO_ADD_SUCCESS = new InternationalizedString("io.add.success");
	...
	private static final InternationalizedString META_QUOTE_START = new InternationalizedString("meta.quoteStart");
	private static final InternationalizedString META_QUOTE_END = new InternationalizedString("meta.quoteEnd");

	////////////////////////////////////////////////////////////////////////////////
	// Instance fields

	private Multiparameter<?> multiparameter;
	...
	public MultiparameterPanel(Multiparameter<?> multiparameter) {
		super();
		...
		// Name label
		String nameLabelText = IO_PROMPT.getValue("{parameter}", multiparameter.userGetName());
		...
		// Constraint label
		String constraintLabelText = multiparameter.userGetConstraints();
	...
	/**
	 * Add to the value of the underlying parameter and update this panel
	 * accordingly.
	 * 
	 * @see Multiparameter#userAddValue(String)
	 */
	private void addValue() {
		try {
			...
			this.updateLabel.setText(IO_ADD_SUCCESS.getValue("{value}", value));
	 ...
	 */
	public void reset() {
		this.multiparameter.reset();
		this.updateLabel
				.setText(IO_RESET_SUCCESS.getValue("{value}", META_QUOTE_START.getValue() + META_QUOTE_END.getValue()));
		this.inputField.setText("");
	}
